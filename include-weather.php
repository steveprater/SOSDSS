...
var Dash = {
    ...
    leftdashboards: [
	{url: "http://www.wunderground.com/cgi-bin/findweather/getForecast?brand=wxmap&query=34.61820,-99.27320&lat=34.61820&lon=-99.27320&zoom=11&type=terrain&units=english&rad=1&rad.num=6&rad.spd=25&rad.opa=70&rad.type=N0R&rad.type2=&rad.smo=1&rad.stm=0&sat=0&svr=0&cams=0&tor=0&wxsn=0&ib=0&mits=0", time: 20},
	{url: "http://rain.wosc.edu/slideshow/forecast.html", time: 12},
	{url: "http://www.weather.com/weather/map/interactive/73521?animation=true", time: 35},
    ],
...
<span id="leftbottom" style="position:absolute;left:20px;bottom:0;width:33%;height:42%;border-bottom: 2px solid #050;border-right:0px solid #050;">
<!-- <iframe width="100%" height="100%" src="http://rain.wosc.edu/slideshow/tv-channel.php" scrolling="no" frameborder="0" style="border: 0px none transparent;"></iframe>

<!-- Commercials PLAYLIST -->
<!-- <iframe width="88%" height="99%" src="http://www.youtube.com/embed/OfJOMWYmTD0?list=PL0A2DBF1AAE117DA9&autoplay=1&loop=1" scrolling="no" frameborder="0"> -->
<!-- Orientation PLAYLIST -->
<!-- <iframe width="95%" height="90%" src="http://www.youtube.com/embed/watch?v=s3BWl5J1OSY&list=PLB98AB184A735F77D&autoplay=1&loop=1" scrolling="no" frameborder="0"> -->
<!-- National Weather Forecast PLAYLIST -->
<iframe width="95%" height="90%" src="http://www.youtube.com/embed/watch?v=_-emMgcxItI&list=PLki90Aw2Gjdf0Bwm5GzP7-s9NJI8xLNTe&autoplay=1&loop=1" scrolling="no" frameborder="0">
<!-- <iframe width="95%" height="90%" src="http://wms5.streamhoster.com/lv_kswotv" scrolling="no" frameborder="0"> -->
