...
<div class="player" id="fms" style="display:block;width:100%;height:100%;margin:20px 0;text-align:center;"></div>
...
$f("fms", "../flow/flowplayer/flowplayer-3.2.7.swf", {
        ...
        plugins: {
                 influxis: {
                        ...
                        netConnectionUrl: 'http://red5.wosc.edu/hds-live/livepkgr/_definst_/liveevent/'
                 }
        }
}
);
